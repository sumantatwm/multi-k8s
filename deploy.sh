...
kubectl apply -f k8s
kubectl set image deployments/server-deployment server=sumantatwm/multi-server:$SHA
kubectl set image deployments/client-deployment client=sumantatwm/multi-client:$SHA
kubectl set image deployments/worker-deployment worker=sumantatwm/multi-worker:$SHA
